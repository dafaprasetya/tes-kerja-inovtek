...
Dashboard rekrutmen sederhana yang dibuat sebagai bagian dari Technical Test Fullstack Developer Junior di **Inovtek Cipta Digital**.

**Live Demo:** [inovtek.prstya.my.id](https://inovtek.prstya.my.id)
...
**Login demo:**
- `admin@inovtek.id` / `dafaprstya`
- `hr@inovtek.id` / `dafaprstya`

> Tanpa Supabase, app tetap berjalan menggunakan mock data dari `lib/mock-data.ts`.

---

## Setup Supabase (Opsional)

Kalau mau pakai database sungguhan:

1. Buat project baru di [supabase.com](https://supabase.com)
2. Buka **SQL Editor**, lalu jalankan query di bawah ini
...
DO $$
DECLARE
  job1 UUID; job2 UUID; job3 UUID; job4 UUID; job5 UUID; job6 UUID;
BEGIN
...
- **Supabase** — PostgreSQL (opsional, ada fallback mock data)
